...
#Github link
github="https://github.com/lfteixeira996/CodeWars/tree/master/C/"
...
#Text to write in the README.md file (in case already exists)
updateMD_2=$"|$proj_num|[$proj_name]($github$proj_diff/$proj_name/README.md) | [Code]($github$proj_diff/$proj_name/$proj_name.c)|[Tests]($github$proj_diff/$proj_name/tests.c)|[CodeWars]($weblink)|:x:|"
...
cd c:
cd Users/$myvar/Desktop/Github/CodeWars/C
...
cd $proj_name/
touch $proj_name.c
echo "$textC" | tee $proj_name.c


touch tests.c
echo "$textC" | tee tests.c
